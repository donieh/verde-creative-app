                            ...
                            <div class="card shadow h-100 py-2" style="background-color:#D9D9D9; border-radius:15px;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col">
                                            <div class="text-s font-weight-bold mb-1" style="color:#004d00;">Total User
                                            </div>
                                        </div>
                                        <div class="col text-right">
                                            <div class="h3 mb-0 font-weight-bold" style="color:#004d00;">{{ $totalStaff }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card shadow h-100 py-2" style="background-color:#D9D9D9; border-radius:15px;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col">
                                            <div class="text-s font-weight-bold mb-1" style="color:#004d00;">Total Pelanggan
                                            </div>
                                        </div>
                                        <div class="col text-right">
                                            <div class="h3 mb-0 font-weight-bold" style="color:#004d00;">{{ $totalClients }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card shadow h-100 py-2" style="background-color:#D9D9D9; border-radius:15px;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col">
                                            <div class="text-s font-weight-bold mb-1" style="color:#004d00;">Total Transaksi
                                            </div>
                                        </div>
                                        <div class="col text-right">
                                            <div class="h3 mb-0 font-weight-bold" style="color:#004d00;">
                                                {{ $totalInvoices }}</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card h-100 py-2"
                                style="background-color:#F5F5F5; border-radius:15px; height:400px; border:#F5F5F5">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <a href="/transaction" class="btn btn-light btn-sm shadow"
                                            style="color: #5A6ACF; border-radius: 5px;">View</a>
                                    </div>
